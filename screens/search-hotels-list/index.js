...
import { Text, View, StyleSheet, Image, TextInput, Pressable, FlatList } from "react-native";
...
const SearchHotelsList = () => {
  ...
  useEffect(() => {
    setHotels([{
      ...
      price: "$187",
      reviewCount: 130,
      description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Eros sed leo, ultrices pellentesque nibh neque. Sed tempus ut mi a. Turpis."
    }, {
      id: 2,
      name: "Pool Apartment",
